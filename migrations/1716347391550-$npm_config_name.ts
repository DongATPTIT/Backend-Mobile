...
export class  $npmConfigName1716347391550 implements MigrationInterface {
    name = ' $npmConfigName1716347391550'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`device-session\` ADD \`test\` varchar(255) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`device-session\` DROP COLUMN \`test\``);
